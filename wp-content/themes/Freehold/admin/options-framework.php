    ...
    <div id="optionsframework-metabox" class="metabox-holder">
	    <div id="optionsframework" class="postbox">
			...
			<div id="optionsframework-submit">
				...
				<input type="submit" class="reset-button button-secondary" name="reset" value="<?php esc_attr_e( 'Restore Defaults', 'optionsframework' ); ?>" onclick="return confirm( '<?php print esc_js( __( 'Theme shared on W P L O C K E R .C O M - Click OK to reset. Any theme settings will be lost!', 'options_framework_theme' ) ); ?>' );" />
				<div class="clear"></div>
			</div>
			</form>
		</div> <!-- / #container -->
...
function optionsframework_validate( $input ) {
	 ...
	 */
		...
		add_settings_error( 'options-framework', 'save_options', __( 'Theme shared on WPLOCKER.COM - Options saved.', 'options_framework_theme' ), 'updated fade' );
		return $clean;
	}
